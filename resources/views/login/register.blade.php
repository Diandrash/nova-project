...
<head>
  ...
  <title>Nova E-Learning | Register</title>
</head>
...
<body>
  <div class="navbar fixed left-0 right-0 top-0 z-50">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-violet-500">
      ...
      <a class="hidden lg:inline-block py-2 px-6 bg-amber-500 hover:bg-amber-600 text-base text-black font-bold rounded-xl transition duration-200" href="#">Sign up</a>
    </nav>
    ...
    <div class="content-area flex flex-wrap">
        ...
        <div class="input-area md:w-7/12 w-full md:bg-white bg-amber-300">
            <div class="content-area mx-10 my-10">
                ...
                <p class="text-base mt-1">Your Epic Adventure Begins Here</p>
                
                <form action="/register" method="POST" class="md:w-10/12 w-full mt-8">
                  @csrf
                    <div class="mb-6">
                        <label for="large-input" class="block mb-2 text-base font-medium text-gray-500">Fullname</label>
                        <input type="text" name="fullname" id="large-input" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" placeholder="John Doe" required>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="large-input" class="block mb-2 text-base font-medium text-gray-500">Instance</label>
                        <input type="text" name="instance" id="large-input" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" placeholder="SMK Negeri 2 Klaten">
                    </div>
                    <div class="mb-6">
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-500 ">Select Role</label>
                        <select id="countries" name="role_id" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="password" name="password" id="large-input" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" placeholder="">
                    </div>

                    <button type="submit" class="py-4 w-full px-5 bg-violet-500 hover:bg-violet-700 text-white font-bold text-xl mt-5 mb-5 rounded-full" onclick="location.href='login.html'">
                        Sign Up
                    </button>

                    <h1 class="mt-3">Already Have an Account? <a href="/login" class="text-blue-500 underline pointer">Login Now</a></h1>
                </form>
            </div>
        </div>
    </div>
