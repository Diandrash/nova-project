...
@section('container')
    ...
    <div class="form-area mt-8 w-6/12">
        <form action="{{ route('assignment.store', ['course' => $course->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="input title mt-6">
                ...
                <input type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 py-3 font-semibold" placeholder="Tugas Project Akhir" required>
            </div>
            <div class="input instruction mt-6">
                ...
                <trix-editor input="instruction" class="h-56 font-medium"></trix-editor>
            </div>
            ...
            <div class="input-files mt-6">
                <label for="files" class="block mb-2 text-base font-medium text-gray-900">Assignment Attachment</label>
                <input type="file" name="files" id="files" class="bg-gray-50 border border-gray-300 text-gray-900 text-base  focus:ring-blue-500 focus:border-blue-500 block w-full">
            </div>
