...
@section('container')
    <div class="welcome-text main flex justify-between">
        <h1 class="text-2xl font-bold">Create a Course</span></h1>
    ...
    <div class="form-area mt-8 w-6/12">
        <form action="/teacher/courses/create" method="post" enctype="multipart/form-data">
            ...
            <div class="input name mt-6">
                ...
                <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-base font-semibold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 py-3" placeholder="Content Creator Class" required>
            </div>
            ...
            <trix-editor input="description" class="h-56"></trix-editor>
