...
@section('container')
    ...
    <div class="course-attributes flex flex-row flex-wrap gap-2">
        ...
        <div class="attribute course-code flex px-5 mt-3 py-1.5 bg-blue-500 hover:bg-blue-700 rounded-full" onclick="location.href='codeCourseTeacher.html'">
        ...
        <div class="attribute materials flex px-5 mt-3 py-1.5 bg-violet-500 hover:bg-violet-700 rounded-full" onclick="location.href='materialsTeacher.html'">
        ...
        <div class="attribute assignments flex px-5 mt-3 py-1.5 bg-amber-300 hover:bg-amber-500 rounded-full" onclick="location.href='assignmentsTeacher.html'">
        ...
        <div class="attribute members flex px-5 mt-3 py-1.5 bg-violet-200 hover:bg-violet-300 rounded-full" onclick="location.href='membersTeacher.html'">
